...
{
    public partial class FormNuevoAbonoProv : Form
    {
        int id;
        public FormNuevoAbonoProv(int id)
        {
            this.id=id;
            InitializeComponent();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                op.editarDeudaProv(id, Convert.ToDouble("-" + tCantidad.Text));
                op.agregarAbonoProv(id, dateTimePicker1.Text, Convert.ToDouble(tCantidad.Text));
