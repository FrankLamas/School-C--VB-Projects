    ...
    public partial class frmAgregarPaciente : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (tNombre.Text!=""||tEdad.Text!=""||cmbSexo.Text!="")
            {
                ...
                op.agregarPaciente(tNombre.Text, tEdad.Text, cmbSexo.Text, tEstatura.Text==""?0:Convert.ToDouble(tEstatura.Text), tPeso.Text==""?0:Convert.ToDouble(tPeso.Text), (tSeguroSocial.Text==""?"N/A":tSeguroSocial.Text));
                this.Close();
            }
            else
            {
